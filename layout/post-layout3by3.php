...
<div class="grid-4">
    <div class="eachPost member_events">
        ...
        <div class="postExcerpt">
            <?php $article_data = substr(get_the_content(), 0, 300);
            echo strip_tags( $article_data ); ?>
        </div>

        <div class="eventLink">
            <a class="button d-block" href="<?php echo $post_url; ?>" <?php if ($post_type != 'post') { ?> target="_blank" <?php } ?>>
                Book now
            </a>
        </div>
